...
After each task, research or implementation - delegate to a subagent to review the changes or findings. The feedback is then provided back to the subagents to fix the implementation if needed. After every change, ensure that the project runs and builds.

Reviewer feedback and any other documentation related to a task should be placed alongside the DESCRIPTION.md in the same 'task directory'.
...
- Vlaanderen style as outlined by flux-web-components documentation
...
- Use flux components to create the UI https://github.com/milieuinfo/flux-web-components
